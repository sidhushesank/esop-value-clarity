  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-3 rounded-full border bg-white px-3 py-2 shadow-sm transition hover:shadow-md"
      >
      ...
      {open && (
        <div className="absolute right-0 z-50 mt-3 w-72 overflow-hidden rounded-2xl border bg-white shadow-2xl">
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 px-5 py-3 text-sm transition ${
        danger ? "text-red-600 hover:bg-red-50" : "hover:bg-slate-100"
      }`}
    >
      {icon}
      {text}
